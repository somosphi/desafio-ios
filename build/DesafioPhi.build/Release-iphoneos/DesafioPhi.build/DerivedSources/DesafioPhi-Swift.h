...
#ifndef DESAFIOPHI_SWIFT_H
#define DESAFIOPHI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DesafioPhi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10DesafioPhi11AppDelegate")
...
SWIFT_CLASS("_TtC10DesafioPhi21ExtractViewController")
...
@interface ExtractViewController (SWIFT_EXTENSION(DesafioPhi)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC10DesafioPhi21ReceiptViewController")
@interface ReceiptViewController : UIViewController
/// Tipo de transação
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified typeTransaction;
/// Valor da transação
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified amount;
/// Favorecido (quem recebeu a transação)
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified favored;
/// Banco que efetuou ou recebeu a transação
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified bank;
/// Data da transação
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified date;
/// Código de autenticação
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified authentication;
...
- (IBAction)prepareShare:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10DesafioPhi13SceneDelegate")
...
SWIFT_CLASS("_TtC10DesafioPhi20TransactionsViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified pix;
...
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified lineConstraint;
